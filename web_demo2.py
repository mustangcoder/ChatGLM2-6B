...
@st.cache_resource
def get_model():
    tokenizer = AutoTokenizer.from_pretrained("E:\workspace\Pythonprojects\model\chatglm2-6b-int4", trust_remote_code=True)
    model = AutoModel.from_pretrained("E:\workspace\Pythonprojects\model\chatglm2-6b-int4", trust_remote_code=True).cuda()
